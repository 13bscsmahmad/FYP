...
#clf = joblib.load('one-class-svm.pkl') # SVC
clf = joblib.load('one-class-svm-final.pkl') # SVM


originalFile = open("test_numeric_imputed.csv", "r")
#newFile = open("test_numeric_prediction_svm.txt", "w") # SVC
newFile = open("test_numeric_prediction_svm-final.txt", "w") # One-class SVM

#os.chmod("test_numeric_prediction_svm.txt",0444) # SVC
os.chmod("test_numeric_prediction_svm-final.txt",0444) # SVC
